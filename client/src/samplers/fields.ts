...
export const SAMPLER_SECTIONS: SamplerSection[] = [
  {
    ...
    fields: [
      ...
      },
      {
        ...
        step: 0.01,
        neutral: 1,
        info: "TabbyAPI canonical name is 'typical'; we send 'typical_p' which it aliases.",
      },
      {
        kind: "slider",
        key: "tfs",
    ...
    fields: [
      {
        ...
        step: 0.01,
        neutral: 0,
        info: "0 disables DRY. Recommended ~0.8 when enabled.",
      },
      {
        kind: "slider",
        key: "dry_base",
      ...
      },
      {
        ...
        step: 1,
        neutral: 0,
        info: "Context window (tokens) DRY looks back over. 0 = whole context.",
      },
      {
        kind: "text",
        ...
        neutral: "",
        info: 'Comma-separated strings that break DRY matching, e.g. \'\\n\', \'.\'.',
      },
    ],
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        step: 64,
        neutral: -1,
        info: "Tokens of context rep penalty applies to. -1 = whole context.",
      },
      {
        kind: "number",
